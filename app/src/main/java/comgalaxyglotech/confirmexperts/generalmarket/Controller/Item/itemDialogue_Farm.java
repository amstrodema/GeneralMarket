package comgalaxyglotech.confirmexperts.generalmarket.Controller.Item;
...
public class itemDialogue_Farm extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.add_item_dialog_farm,null);
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (itemDialogue_Farm.itemDialogListener) context;
