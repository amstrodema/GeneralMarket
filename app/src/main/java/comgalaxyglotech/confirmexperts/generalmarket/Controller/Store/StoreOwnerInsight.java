...
public class StoreOwnerInsight extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_store_owner_insight);
        basePanelListeners();
    }
    private void basePanelListeners(){
        ...
        store.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StoreOwnerInsight.this,StoreOwnerHome.class);
        ...
        trades.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StoreOwnerInsight.this,StoreOwnerTrades.class);
                intent.putExtra("storeId", storeId);
                intent.putExtra("creatorId",creatorId);
                startActivity(intent);
                finish();
        ...
        wallet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StoreOwnerInsight.this,StoreOwnerWallet.class);
                intent.putExtra("storeId", storeId);
                intent.putExtra("creatorId",creatorId);
                startActivity(intent);
                finish();
        ...
        insight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StoreOwnerInsight.this,StoreOwnerInsight.class);
                intent.putExtra("storeId", storeId);
                intent.putExtra("creatorId",creatorId);
                startActivity(intent);
                finish();
